...
|---|---|---|---|---|---|---|---|
| AutomatedEmpires | `automatedempires` | project `…TxHhy9w1` | Connected to venture repository | `main` | `.` | Default `664cda67bc7bc91e4f1577d76bbe7758290f3a2d`; clean merged-main production `dpl_4b8tDpSmz71WTGmrgRigPb7k5bT9` is `READY` and a rollback candidate; public DNS remains Website Builder | Canonical; source/main deployment provenance fixed; DNS smoke/cutover open |
