...
|---|---|---|---|---|
| AutomatedEmpires | `AutomatedEmpires/automatedempires` | `ci / verify`, `ci / design-guardrails`; default CodeQL | Current default `ed91ece423583318fd7481278a7478311d867add`; site PR #5 and Dependabot #7 merged; clean production `dpl_5scDXWyVV2wq1ypwhcjmiBkQLpzT` `READY`; ops #6 remains draft until this pack is rebased/published | **Fixed and verified**; ops publication open |
