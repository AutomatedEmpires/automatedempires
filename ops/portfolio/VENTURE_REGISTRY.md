...
|---|---|---|---|---|---|---|
| AutomatedEmpires | `automatedempires` | Parent company and public portfolio authority | `AutomatedEmpires/automatedempires` | `automatedempires.com` is registered at GoDaddy; the apex currently resolves to GoDaddy Website Builder | Dedicated Vercel project has a protected `READY` PR preview; no production deployment or custom domain is attached | No Supabase project; none is currently needed for the public studio site |
