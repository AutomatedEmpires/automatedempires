...
| Dev/stg/prd point to Clerk development instance `ins_3EhjrYiNBzhqkZlG9kIc2Gh4dSy`; health reports Clerk webhook absent | **Confirmed cross-environment contamination** | Production identity/user sync is not ready |
...
| No Sweepza-specific Resend, PostHog, or Sentry project was provider-verified | **Unknown/missing** | Email/analytics/errors cannot be declared transfer-ready |
