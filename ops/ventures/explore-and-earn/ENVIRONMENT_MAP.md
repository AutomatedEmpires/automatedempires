...
| Production | Doppler/Vercel contain the scoped Resend identity; current Stripe production binding remains unactivated/unproven | Clean production `dpl_5HCPaCNCQuyip2iZTHpoMvSxjQFY` from prior source `b616b9e10fa434422dd34442f6cb24194cf8d5ec` is `READY`; current source includes #245 `5989853` without a recorded later public Production deployment | Dedicated Supabase; #245 privacy/report migration evidence is live. Dark Clerk DNS Verified/SSL Issued; runtime pending. Resend delivery and Stripe account/webhook proof remain open. | **Older operational web runtime; current-source/auth/billing/mail acceptance incomplete** |
