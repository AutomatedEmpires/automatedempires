...
| Hosting | **Verified current** | Vercel project `automatedempires` is connected to `AutomatedEmpires/automatedempires`, branch `main`, root `.`, Next.js/Node 24; no deployment or domain is attached. | Authenticated Vercel inventory |
