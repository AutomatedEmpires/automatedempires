...
| ORAN deployment, DNS, schema, Azure, and Mailgun | Critical/high security findings, zero safe deployment baseline, schema authority mismatch, broken Azure target, unknown billing | ORAN recovery/security owner and founder | Security and ancillary gates green, schema authority reconciled, safe Preview and functional recovery proven, Azure/Mailgun retention decided |
